...
public class ArticleActivity extends AppCompatActivity
    ...
    /**
     * URL for articles data from the GUARDIAN
     */
    private static final String REQUEST_URL =
            "http://content.guardianapis.com/search?q=debates&api-key=18475dc9-77b5-43f0-92a7-ae21053f325a&show-tags=contributor";
    /**
    ...
    public Loader<List<Article>> onCreateLoader(int i, Bundle bundle) {
        ...
        Log.e(LOG_TAG, "order by " + orderBy);
