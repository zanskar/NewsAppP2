...
final class QueryUtils {
    ...
    public static List<Article> fetchArticleData(String requestUrl) {
        ...
        // Extract relevant fields from the JSON response and create a list of {@link Article} (and return this data at the end)
    ...
    private static List<Article> extractFeatureFromJson(String newsJSON) {
        ...
        try {
            ...
            for (int i = 0; i < articleArray.length(); i++) {
                ...
                String originalPublicationDate = currentArticle.getString("webPublicationDate");
                ...
                // Create a new {@link Article} object with the title, section name, publication date,
                // and url from the JSON response.
                Article article = new Article(title, sectionName, authorFullName, publicationDate, url);
